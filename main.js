  ...
  if (form) {
    form.addEventListener('submit', (e) => {
      ...
      if (q) {
        ...
        const searchPath = isIndex ? 'src/pages/search.html' : 'search.html'; // Assuming all pages are in src/pages except index
        ...
        window.location.href = (window.location.pathname.includes('/src/pages/') ? 'search.html' : 'src/pages/search.html') + '?q=' + encodeURIComponent(q);
      }
    });
  }
}
